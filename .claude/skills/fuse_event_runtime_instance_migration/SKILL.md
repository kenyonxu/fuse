...
- [ ] 确认 Event 可能被多个节点共享
- [ ] 备份原始 Event 文件
- [ ] 阅读 [完整迁移指南](addons/fuse/docs/dev_docs/archive/migration-guide-to-runtime-instance.md)
...
### 核心文档
- **完整迁移指南**：[addons/fuse/docs/dev_docs/archive/migration-guide-to-runtime-instance.md](addons/fuse/docs/dev_docs/archive/migration-guide-to-runtime-instance.md)
- **快速开始指南**：[docs/plans/event-migration-quick-start.md](docs/plans/event-migration-quick-start.md)
- **重构执行摘要**：[docs/plans/2025-02-03-runtime-instance-refactoring-execution-summary.md](docs/plans/2025-02-03-runtime-instance-refactoring-execution-summary.md)
