...
As you might have already read in [Audio buses](https://docs.godotengine.org/en/stable/tutorials/audio/audio_buses.html#doc-audio-buses), sound is sent to each bus via an AudioStreamPlayer node. There are different kinds of AudioStreamPlayers. Each one loads an AudioStream and plays it back.

## AudioStream[](#audiostream "Link to this heading")

An audio stream is an abstract object that emits sound. The sound can come from many places, but is most commonly loaded from the filesystem. Audio files can be loaded as AudioStreams and placed inside an AudioStreamPlayer. You can find information on supported formats and differences in [Importing audio samples](https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/importing_audio_samples.html#doc-importing-audio-samples).

There are other types of AudioStreams, such as [AudioStreamRandomizer](https://docs.godotengine.org/en/stable/classes/class_audiostreamrandomizer.html#class-audiostreamrandomizer). This one picks a different audio stream from a list of streams each time it's played back, and applies random pitch and volume shifting. This can be helpful for adding variation to sounds that are played back often.

## AudioStreamPlayer[](#audiostreamplayer "Link to this heading")

![../../_images/audio_stream_player.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_player.webp)
...
## AudioStreamPlayer2D[](#audiostreamplayer2d "Link to this heading")

![../../_images/audio_stream_2d.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_2d.webp)
...
![../../_images/audio_stream_2d_area.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_2d_area.webp)

## AudioStreamPlayer3D[](#audiostreamplayer3d "Link to this heading")

![../../_images/audio_stream_3d.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_3d.webp)
...
![../../_images/audio_stream_3d_area.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_3d_area.webp)

Unlike for 2D, the 3D version of AudioStreamPlayer has a few more advanced options:

### Reverb buses[](#reverb-buses "Link to this heading")
...
See [Audio playback in the Exporting for the Web documentation](https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_web.html#doc-exporting-for-web-audio-playback) for details.
...
![../../_images/audio_stream_reverb_bus.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_reverb_bus.webp)
...
![../../_images/audio_stream_reverb_bus2.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_reverb_bus2.webp)
...
### Doppler[](#doppler "Link to this heading")
...
![../../_images/audio_stream_doppler.webp](https://docs.godotengine.org/en/stable/_images/audio_stream_doppler.webp)
