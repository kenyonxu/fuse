...
## Decibel scale[](#decibel-scale "Link to this heading")
...
## Audio buses[](#id1 "Link to this heading")

Audio buses can be found in the bottom panel of the Godot editor:

![../../_images/audio_buses1.webp](https://docs.godotengine.org/en/stable/_images/audio_buses1.webp)
...
![../../_images/audio_buses2.webp](https://docs.godotengine.org/en/stable/_images/audio_buses2.webp)

In the above image, the output of *Bus 2* has been routed to the *Master* bus.

## Playback of audio through a bus[](#playback-of-audio-through-a-bus "Link to this heading")

To test passing audio to a bus, create an AudioStreamPlayer node, load an AudioStream and select a target bus for playback:

![../../_images/audio_buses3.webp](https://docs.godotengine.org/en/stable/_images/audio_buses3.webp)

Finally, toggle the **Playing** property to **On** and sound will flow.

See also

You may also be interested in reading about [Audio streams](https://docs.godotengine.org/en/stable/tutorials/audio/audio_streams.html#doc-audio-streams) now.

## Adding effects[](#adding-effects "Link to this heading")
...
For information on what each effect does, see [Audio effects](https://docs.godotengine.org/en/stable/tutorials/audio/audio_effects.html#doc-audio-effects).

## Automatic bus disabling[](#automatic-bus-disabling "Link to this heading")
...
![../../_images/audio_buses5.webp](https://docs.godotengine.org/en/stable/_images/audio_buses5.webp)

Disabled buses have a blue VU meter instead of a red-green one.[](#id2 "Link to this image")

## Bus rearrangement[](#bus-rearrangement "Link to this heading")
...
## Default bus layout[](#default-bus-layout "Link to this heading")
