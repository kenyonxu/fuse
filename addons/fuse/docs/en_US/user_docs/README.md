> 🌐 [**中文版**](../../zh_CN/user_docs/README.md) | English
...
|------|------|
| [Quick Start](quick_start.md) | Get started with the Fuse system in 5 minutes |
| [Features](FEATURES.md) | Overview of Fuse features |

---

## 📖 Usage guides (39 articles, five-layer learning path)

### 🟢 Layer 1: Getting started (01-06)
...
| Category | Count |
|------|------|
| Entry documents | 2 (quick_start, FEATURES) |
| Usage guides | 39 (`guides/`) |
| Best practices | 2 (`best_practices/`) |
| Update spec | 1 ([UPDATE_SPEC.md (Chinese)](../../zh_CN/user_docs/UPDATE_SPEC.md)) |
| **Total** | **43** + spec |
...
- **Adding guides**: usage guides go into `guides/`, best practices into `best_practices/`; register them under the corresponding group in this README
- **Link health**: when adding/modifying documents, make sure all relative links point to files that actually exist
- **Responsibility boundaries**: usage questions belong to this directory; development implementation details to `dev_docs/`; architecture design to `system_docs/`

---

**Last updated**: 2026-07-07
**Maintainers**: Fuse development team
