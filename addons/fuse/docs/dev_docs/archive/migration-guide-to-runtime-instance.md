...
- [RuntimeInstance 架构模式](../../architecture/runtime-instance-pattern.md) - 详细设计文档
- [Event 资源共享问题解决方案](event-resource-sharing-solution.md) - 问题背景和方案选择
- [快速迁移指南](../../../../docs/plans/event-migration-quick-start.md) - 快速入门
