...
创建 `addons/fuse/tests/conditions/test_<condition_name>.tscn`：

```gdscript
[gd_scene load_steps=2 format=3 uid="uid://test_xxx"]

[ext_resource type="Script" path="res://addons/fuse/tests/conditions/test_xxx.gd" id="1"]
...
创建 `addons/fuse/tests/conditions/test_<condition_name>.gd`：
