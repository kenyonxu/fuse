...
```bash
# Windows
"E:\Godot\Godot_v4.5.1-stable_mono_win64\Godot_v4.5.1-stable_mono_win64.exe" --path "E:\Godot\GodotProjects\project-juicy-godot" "addons/fuse/tests/test_localization.tscn"

# Linux/Mac
godot --path /path/to/project addons/fuse/tests/test_localization.tscn
```
