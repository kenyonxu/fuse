...
- **测试脚本**: `addons/fuse/tests/test_stage3_runtime_localization.gd`
- **测试场景**: `addons/fuse/tests/test_stage3_runtime_localization.tscn`
...
1. 在 Godot 编辑器中打开项目
2. 打开测试场景：`addons/fuse/tests/test_stage3_runtime_localization.tscn`
3. 按 F5 运行场景
4. 查看控制台输出
...
确保测试场景文件在正确的位置：
```
addons/fuse/tests/test_stage3_runtime_localization.tscn
```
