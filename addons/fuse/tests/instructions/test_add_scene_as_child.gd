...
func test_basic_functionality():
	...
	instruction.scene_path = "res://addons/fuse/tests/instructions/test_scene_to_instance.tscn"
...
func test_error_handling():
	...
	instruction4.scene_path = "res://addons/fuse/tests/instructions/test_scene_to_instance.tscn"
