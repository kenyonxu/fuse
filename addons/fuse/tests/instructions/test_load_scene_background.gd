...
# 测试场景路径
const TEST_SCENE_PATH = "res://addons/fuse/tests/instructions/test_load_scene_background_test_scene.tscn"
...
func _ensure_test_scene_exists():
	var test_scene_path = "res://addons/fuse/tests/instructions/test_load_scene_background_test_scene.tscn"
