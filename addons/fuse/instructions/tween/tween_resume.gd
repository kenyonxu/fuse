...
func _update_resource_name():
	...
	if use_variable_for_target:
		...
		if not target_node.is_empty():
			target_str = _get_node_display_name(target_node)
		else:
			target_str = FuseLocalization.translate("FUSE_COMMON_CURRENT_NODE")
...
func get_description() -> String:
	...
	if use_variable_for_target:
		...
		target_desc = _get_node_display_name(target_node) if not target_node.is_empty() else FuseLocalization.translate("FUSE_COMMON_CURRENT_NODE")
